...
class MainPage(Screen):
    def __init__(self, **kwargs):
        ...
        box.add_widget(Button(text="PLAY", on_press=self.OnPressFight, background_color=globalVar.buttonColor))
        box.add_widget(Button(text="STORE", on_press=self.OnPressStore, background_color=globalVar.buttonColor))
        box.add_widget(Button(text="PROFILE", on_press=self.OnPressProfile, background_color=globalVar.buttonColor))
        box.add_widget(Button(text="SETTING", on_press=self.OnPressSettings, background_color=globalVar.buttonColor))
        box.add_widget(Button(text="EXIT", on_press=self.OnPressExit, background_color=globalVar.buttonColor))
