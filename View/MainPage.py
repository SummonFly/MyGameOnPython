...
class MainPage(Screen):
    def __init__(self, **kwargs):
        ...
        box.add_widget(Button(text="PLAY", on_press=self.OnPressFight, background_color=globalVar.buttonColor, color=globalVar.buttonTextColor,  background_normal=''))
        box.add_widget(Button(text="STORE", on_press=self.OnPressStore, background_color=globalVar.buttonColor, color=globalVar.buttonTextColor, background_normal=''))
